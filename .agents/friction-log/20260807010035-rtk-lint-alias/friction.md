---
title: 'rtk lint alias maps to nonexistent eslint; real lint gate is pnpm exec oxlint src (pnpm run lint)'
severity: 'minor'
---
...
<!-- Describe what happens instead. Required. -->

### Possible Solution

<!-- Optional. Suggest a fix or a reason for the friction. -->
