  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <BlurCommitTextarea
        id="cs-desc"
        label="Description"
        placeholder={config?.character.description ? `Original: ${config.character.description.slice(0, 60)}…` : "Character description"}
      ...
      <BlurCommitTextarea
        id="cs-personality"
        label="Personality"
        placeholder={config?.character.personality ? `Original: ${config.character.personality.slice(0, 60)}…` : "Character personality"}
      ...
      <BlurCommitTextarea
        id="cs-scenario"
        label="Scenario"
        placeholder={config?.character.scenario ? `Original: ${config.character.scenario.slice(0, 60)}…` : "Character scenario"}
      ...
      <BlurCommitTextarea
        id="cs-sys-prompt"
        label="System prompt"
        placeholder={config?.character.system_prompt ? `Original: ${config.character.system_prompt.slice(0, 60)}…` : "Character system prompt"}
