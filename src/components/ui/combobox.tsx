...
function ComboboxChipsInput({ className, ...props }: ComboboxPrimitive.Input.Props) {
  return (
    <ComboboxPrimitive.Input
      ...
      className={cn("min-w-16 flex-1 outline-none focus-visible:ring-3 focus-visible:ring-ring/30", className)}
      {...props}
    />
  );
}
