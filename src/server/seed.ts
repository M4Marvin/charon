...
export function seedDemoCharactersForExistingUser(userId: string, db: DB = defaultDb): void {
  createDemoCharacter(
    userId,
    "demo-captain",
    {
      ...
      depth_prompt: {
        prompt:
          "Jack's hidden guilt and past in the navy should inform his moments of seriousness.",
        depth: 4,
        role: "system",
      },
    },
